      ...
      <Container>
            ...
            <CardItem >
              <View>
                ...
                <View style={{flexDirection: 'row'}}>
                  <Text style={{fontWeight: 'bold'}}>{username}<Thumbnail source={require('../../images/tick.png')} /></Text>
                  <Icon name='chevron-down' style={{fontSize: 12, color: '#1DA1F2', alignSelf: 'center', paddingLeft: 110}}/>
                </View>
        ...
        <Footer style={{backgroundColor: '#ffffff'}}>
          <FooterTab style={{backgroundColor: '#ffffff'}}>
            <Left>
              <Icon style={{ marginLeft: 10, color: '#1DA1F2', fontSize: 20 }} name='moon-o'></Icon>
            </Left>
            <Right>
              <Icon style={{ marginRight: 10, color: '#1DA1F2', fontSize: 20 }} name='qrcode'></Icon>
            </Right>
          </FooterTab>
        </Footer>
      </Container>
